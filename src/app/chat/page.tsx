...
export default function ChatPage() {
  ...
  const handleCreateNewRoom = () => {
    ...
    router.push(`/chat/join/${newRoomId}`);
  };
      ...
      <div className="w-full max-w-md p-8 space-y-8 glass-morphism rounded-xl shadow-xl animate-fade-in">
        ...
        <div className="space-y-4">
          <button
            ...
            disabled={isLoading}
            className="w-full flex items-center justify-center gap-2 py-3 px-4 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-colors disabled:opacity-70"
          >
            <Plus size={18} />
